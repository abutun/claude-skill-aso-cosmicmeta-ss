...
TRANSLATION_PROMPT_TEMPLATE = (
    ...
    "The APP NAME / BRAND NAME shown on the device screen MUST stay exactly as-is.\n"
    "Do NOT translate, alter, rewrite, or paraphrase the app name under any circumstances.\n"
    "The app name is a proper noun / trademark — it is the same in every language.\n"
    "══════════════════════════════════════════════\n\n"
    "WHAT TO TRANSLATE:\n"
    "1. HEADLINE (outside device) — the large bold action verb and descriptor above the device frame\n"
    "2. IN-APP UI TEXT (inside device screen) — readable button labels, menu items, "
    "section titles, tab names, and short UI strings visible inside the app screenshot. "
    "Examples: 'PLAY', 'SETTINGS', 'PROFILE', 'DAILY CHALLENGE', 'HOW TO PLAY', etc.\n\n"
    "WHAT TO NEVER TRANSLATE:\n"
    "- APP NAME / BRAND NAME — must remain pixel-perfect identical to the original\n"
    "- Version numbers, build strings\n"
    "- Scores, timers, countdown values, currency amounts\n"
    "- Usernames, player names, profile handles\n"
    "- Any numeric values\n"
    "- Placeholder or decorative text too small to read clearly\n\n"
    "TRANSLATION RULES — HEADLINE:\n"
    "- Use idiomatic, compelling expressions in {language} — NOT word-for-word literal translation\n"
    "- Keep ALL CAPS rendering style for the headline\n"
    "- Preserve exact font weight, size, color, positioning, and drop shadows\n"
    "- If the {language} translation is significantly longer, use a shorter idiomatic equivalent\n\n"
    "TRANSLATION RULES — IN-APP UI TEXT:\n"
    "- Translate button labels and menu text naturally and concisely — UI text must fit its container\n"
    "- If a translated label is too long to fit the button/tab, use a common abbreviation or "
    "the shortest natural equivalent in {language}\n"
    "- Preserve the original font size, weight, color, and alignment of each UI element\n\n"
    "SPECIAL CHARACTERS — CRITICAL:\n"
    "- ALL language-specific characters MUST be correct in both headline and UI text:\n"
    "  Turkish: İ/i (never I/i), Ç, Ö, Ü, Ğ, Ş\n"
    "  German: Ä, Ö, Ü, ß (SS in all-caps contexts)\n"
    "  French/Spanish: É, Ñ, À, Ü, etc.\n"
    "- Never strip, replace, or ASCII-ify special characters anywhere in the image\n\n"
    "DO NOT CHANGE:\n"
    "- The app name / brand name — this is the most important rule in this prompt\n"
    "- The device frame itself\n"
    "- Background color, gradient, and all decorative visual elements outside the device\n"
    "- App screenshots, graphics, icons, illustrations, and images inside the device\n"
    "- The overall layout and composition\n"
    "- Image dimensions\n\n"
    "QUALITY CONSTRAINTS:\n"
    "- Maintain exact image dimensions\n"
    "- Translated UI text must look native — same visual weight and style as the original\n"
    "- If a UI text element is too small or unclear to translate reliably, leave it unchanged\n"
    "- The result should look like the app was originally built in {language}, not machine-translated\n\n"
    "FINAL REMINDER: The app name is a trademark. It must appear exactly as in the original image. "
    "Do not translate it. Do not modify it. Do not paraphrase it."
)
