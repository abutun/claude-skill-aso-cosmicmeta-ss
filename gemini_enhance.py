...
TRANSLATION_PROMPT_TEMPLATE = (
    ...
    "2. IN-APP UI TEXT (inside device screen) — any readable button labels, menu items, "
    ...
    "- Do NOT translate: app name/title, version numbers, scores, timers, currency amounts, "
    "usernames, or any numeric values\n"
    "- Do NOT translate placeholder or decorative text that is too small to read clearly\n\n"
